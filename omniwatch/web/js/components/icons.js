...
const ICONS = {
  ...
  hourglass: [P('M4 1.75h8M4 14.25h8'), P('M4.75 1.75c0 3 3.25 4 3.25 6.25S4.75 11.25 4.75 14.25M11.25 1.75c0 3-3.25 4-3.25 6.25s3.25 3.25 3.25 6.25'), P('M6.25 12.5 8 11l1.75 1.5z', {})],
  history: [P('M2.5 8a5.5 5.5 0 1 0 1.6-3.9'), P('M2.25 2.5v2.75H5'), P('M8 5v3.25l2.25 1.5')],
  pause: [C(8, 8, 6), P('M6.5 5.75v4.5M9.5 5.75v4.5')],
  trend: [P('M1.75 11.5 5.5 7.75l2.75 2.5 5.5-5.75'), P('M10.5 4.5h3.25v3.25')],
  code: [P('M5.5 4.5 2 8l3.5 3.5M10.5 4.5 14 8l-3.5 3.5'), P('M9 3 7 13')],
  power: [P('M8 1.75v5.5'), P('M4.6 3.9a5.25 5.25 0 1 0 6.8 0')],
  menubar: [R(1.75, 2.25, 12.5, 11.5, 1.75), P('M1.75 5.5h12.5'), P('M10.5 3.9h1.5')],
};
